...
// The parent's own thread with the Novelia team. Keyed by the parent's id
    ...
    <div className="space-y-6">
      <div className="boardgrid relative flex items-center gap-4 overflow-hidden rounded-2xl bg-board p-7 text-white">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-white/50">Talk to the Novelia team about your child's progress.</p>
        </div>
      </div>
