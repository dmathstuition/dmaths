...
export const metadata = {
  title: "Verify a certificate — Novelia Academy",
  description: "Confirm that a Novelia certificate or report card is genuine.",
};
  ...
  return (
    <main className="boardgrid flex min-h-screen flex-col items-center justify-center bg-board p-6 text-center text-white">
      ...
      <p className="mt-2 max-w-md text-sm text-white/55">
        Enter the code printed on a Novelia certificate or report card to confirm it&apos;s genuine.
        You&apos;ll see the learner&apos;s name and when it was issued — nothing else.
      </p>
      <div className="mt-8 flex justify-center">
        <VerifyForm />
      </div>
      <Link href="/" className="mt-10 text-sm font-semibold text-white/50 hover:text-white">← Back to Novelia</Link>
    </main>
  );
}
