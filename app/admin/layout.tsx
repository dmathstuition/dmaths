...
const NAV: NavItem[] = [
  ...
  { href: "/admin/daily-tasks", label: "Task of the day", icon: "checkCircle" },
  { href: "/admin/at-risk", label: "Students to watch", icon: "alertTriangle" },
  ...
  { href: "/admin/aptitude", label: "Aptitude tests", icon: "graduationCap" },
  { href: "/admin/mock-exams", label: "Mock exams", icon: "graduationCap" },
  { href: "/admin/mock-requests", label: "Mock requests", icon: "graduationCap" },
