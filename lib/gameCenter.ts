...
// ── NOVELIA ACADEMY GAME CENTER — single source of truth ─────────────────────
...
export const GAME_CENTER: GameEntry[] = [
  ...
  { id: "sprint", title: "Math Sprint", blurb: "Race the clock through rapid-fire questions.", href: "/portal/sprint", icon: "star", accent: "#F5951E", group: "Arcade" },
  ...
  { id: "focus", title: "Focus Mode", blurb: "Beat distraction with focused study sprints.", href: "/portal/focus", icon: "target", accent: "#1657C9", group: "Arcade" },

  // ── Compete — climb the boards ──
  { id: "leagues", title: "Leagues", blurb: "Win your weekly division and get promoted.", href: "/portal/leagues", icon: "trophy", accent: "#F5951E", group: "Compete" },
  { id: "leaderboard", title: "Leaderboard", blurb: "See who's topping the school this season.", href: "/portal/leaderboard", icon: "crown", accent: "#C56A12", group: "Compete" },

  // ── Rewards & style — spend and show off ──
  { id: "badges", title: "Badges", blurb: "Collect badges for every milestone you hit.", href: "/portal/badges", icon: "medal", accent: "#F5951E", group: "Rewards & style" },
  ...
  { id: "skills", title: "Knowledge Map", blurb: "Unlock topics as your skills grow.", href: "/portal/skills", icon: "mapPin", accent: "#1657C9", group: "Labs & maps" },
